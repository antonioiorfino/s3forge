 ...
 *
 * <p>This operation is used by the AWS SDK during region discovery. Even though S3Forge has only a
 * single region, the operation must be implemented so that SDK clients can complete their
 * initialization sequence without errors.
 *
 * @since 0.1.0
 */
class GetBucketLocationTest {
    ...
    /**
     * An existing bucket returns an empty location constraint, which AWS clients universally map to
     * {@code us-east-1}.
     */
    @Test
