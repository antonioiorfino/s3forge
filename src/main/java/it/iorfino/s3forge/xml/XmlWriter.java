...
/**
 * Minimal, allocation-friendly XML builder used to produce S3-style response
 * bodies.
 *
 * <p>This class intentionally does not aim to be a general-purpose XML
 * serializer. It only supports the subset of XML needed by S3Forge: a
 * declaration header, nested elements, and text content. All text passed to
 * {@link #element(String, String)} is escaped via {@link XmlEscaper}.</p>
 *
 * <p>Instances are <strong>not</strong> thread-safe.</p>
 *
 * @since 0.1.0
 */
public final class XmlWriter {
     ...
     *
     * <p>Use with care: the caller is responsible for ensuring the fragment
     * is well-formed and safe.</p>
     *
